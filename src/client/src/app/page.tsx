...
// Next.js Image handling - using paths relative to public
const aiChatMockup = "/assets/ai-chat-mockup.png";
const flowchartMockup = "/assets/flowchart-mockup.png";
const flashcardsMockup = "/assets/flashcards-mockup.png";
const quizMockup = "/assets/quiz-mockup.png";
...
export default function Home() {
  return (
    <div className="dark min-h-screen bg-background overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 pt-32 pb-20 text-center">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold leading-[1.05] mb-8 tracking-tight">
            ...
            <span className="inline-block opacity-0 animate-fade-in" style={{ animationDelay: "0.4s" }}>
              <span className="bg-gradient-to-r from-primary via-cyan-400 to-primary bg-clip-text text-transparent italic">Artificial Intelligence</span>
            </span>
          </h1>
      ...
      {/* Features Section - Light Theme applied to content */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex items-center gap-8 text-sm">
              <div className="text-[10px] uppercase tracking-widest font-bold text-white/20 hover:text-primary cursor-pointer transition-colors px-4 py-1.5 rounded-full bg-white/[0.03] border border-white/[0.08]">
                Admin Panel Access Only for Authorized Personnel
              </div>
