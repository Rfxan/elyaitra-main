...
const NAV_SECTIONS = [
  {
    items: [
      { label: 'Dashboards', icon: LayoutDashboard, href: '/admin/dashboard' },
      { label: 'Elyaitra AI', icon: Sparkles, href: '/admin/dashboard/ai', badge: null },
    ],
  },
  {
    title: 'Triage',
    items: [
      { label: 'Alerts', icon: AlertTriangle, href: '/admin/dashboard/alerts' },
      { label: 'Misconfigurations', icon: ShieldAlert, href: '/admin/dashboard/misconfigurations' },
      { label: 'Vulnerabilities', icon: Bug, href: '/admin/dashboard/vulnerabilities' },
      { label: 'Compliance', icon: CheckSquare, href: '/admin/dashboard/compliance' },
    ],
  },
  {
    title: 'Discover',
    items: [
      { label: 'Event Visibility', icon: Eye, href: '/admin/dashboard/visibility' },
    ],
  },
  {
    title: 'Configure',
    items: [
      { label: 'Detect', icon: SearchIcon, href: '/admin/dashboard/detect' },
      { label: 'Agents', icon: Monitor, href: '/admin/dashboard/agents' },
      { label: 'Report', icon: FileText, href: '/admin/dashboard/report' },
      { label: 'Policies', icon: ScrollText, href: '/admin/dashboard/policies' },
    ],
  },
]
        ...
        <div className="flex items-center justify-between px-3 h-12 border-b" style={{ borderColor: '#2a2a45' }}>
          {!collapsed && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-bold text-white tracking-wide">Elyaitra <span className="text-purple-400">One</span></span>
            </div>
          )}
          <button
        ...
        {!collapsed && (
          <div className="px-3 py-3 border-t flex items-center gap-2" style={{ borderColor: '#2a2a45' }}>
            ...
            <div className="text-[11px]">
              ...
              <div style={{ color: '#6b6b8d' }}>v2.4.0</div>
            </div>
          </div>
        )}
      </aside>
        ...
        <header className="h-10 border-b flex items-center justify-between px-4 flex-shrink-0" style={{ background: '#fff', borderColor: '#e2e5ea' }}>
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1 text-xs text-gray-500">
              ...
              <span className="text-gray-300">›</span>
              <span className="text-gray-700 font-semibold">Security Dashboard</span>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div className="w-7 h-7 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white text-[10px] font-bold cursor-pointer">
              AD
            </div>
          </div>
        </header>
