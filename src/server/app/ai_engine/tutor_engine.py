...
class TutorEngine:
    ...
    def respond(
        ...
        *,
        ...
        # 3. Syllabus lock
        # --------------------
        syllabus_context = "\n".join(docs) if docs else "[No specific snippets found in the textbook for this unit. Use your general knowledge to judge if this is relevant to the subject/unit.]"
