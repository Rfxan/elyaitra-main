...
def ingest():
    ...
    for file in os.listdir(DATA_PATH):
        ...
        for i in range(0, len(chunks), batch_size):
            ...
            # LLMProvider uses embed_batch, not embed_documents (langchain style)
            # though our providers have wrappers, it's safer to use the base method
            chunk_embeddings = embeddings.embed_batch(batch)
